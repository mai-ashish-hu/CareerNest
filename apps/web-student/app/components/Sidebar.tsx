    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-surface-900 text-white flex flex-col z-40">
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center font-bold text-white', 'bg-gradient-to-br from-emerald-600 to-teal-500')}>CN</div>
          <div><h1 className="font-bold text-lg">CareerNest</h1><p className="text-xs text-surface-400">Student Portal</p></div>
        </div>
      </div>
